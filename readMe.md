...
##Initial Setup
* Add Landing Page
* Add Songs Page that lists all songs
...
##Creating New Songs
* Setup new song POST route
* Add in body-parser
* Setup route to show form
* Add basic unstyled form

##Style the songs page
* Add a better header/title
* Make songs display in a grid

##Style the Navbar and Form
* Add a navbar to all templates
* Style the new song form

##Add Mongoose
* Install and configure Mongoose
* Setup song model
* Use song model inside of our routes

##Show Page
* Review the RESTful routes we've seen so far
* Add description to our song model
...
* Display notes on song show page

##Note New/Create
* Discuss nested routes
* Add the note new and create routes
* Add the new note form

##Style Show Page
* Add sidebar to show page
* Display notes nicely
...
* Add logout route
* Prevent user from adding a note if not signed in
* Add links to navbar
...
* Save author's name to a note automatically

##Users + Songs
* Prevent an unauthenticated user from creating a song
* Save username+id to newly created song

# Editing Songs
* Add Method-Override
* Add Edit Route for Songs
...
#Authorization Part 1: Songs
* User can only edit his/her songs
* User can only delete his/her songs
* Hide/Show edit and delete buttons

#Editing Notes
* Add Edit route for notes
* Add Edit button
* Add Update route

<!--/songs/:id/edit-->
<!--/songs/:id/notes/:note_id/edit-->

#Deleting Notes
* Add Destroy route
* Add Delete button

#Authorization Part 2: Notes
* User can only edit his/her notes
* User can only delete his/her notes
* Hide/Show edit and delete buttons
* Refactor Middleware
...
NEW     songs/:id/notes/new    GET
CREATE  songs/:id/notes      POST
